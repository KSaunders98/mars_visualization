...
#include <vector>
#include <memory>
#include "GLViewMarsVisualization.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewMarsVisualization > glView( Aftr::GLViewMarsVisualization::New( args ) );
